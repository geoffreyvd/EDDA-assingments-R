...
```{r fig.width=8, fig.height=3, echo=FALSE}
par(mfrow=c(1,5))
plot(data$expend, data$bad,xlab="expend",ylab="bad")
plot(data$expend, data$crime,xlab="expend",ylab="crime")
plot(data$expend, data$lawyers,xlab="expend",ylab="lawyers")
plot(data$expend, data$employ,xlab="expend",ylab="employ")
plot(data$expend, data$pop,xlab="expend",ylab="pop")
```
