...
**f)** <!-- Given the way the experiment was conducted, is this second approach wrong? --> No, the second approach is not wrong. It calculates the exact p-value based on the proportions of the data.

**g)** <!-- Name both an advantage and a disadvantage of the two approaches, relative to each other. --> 
An advantage of Fisher's exact test over logistic regression is that it is more suitable to work with smaller numbers as is the case in our experiment.
An advantage of logistic regression is that it includes a predictive model which the Fisher exact test lacks.